...
class AzureOpenAIProvider(Provider):
    ...
    async def _handle_request(self, deployment_id: str | None, raw_request: Request, app) -> JSONResponse:
            ...
            async def stream_response():
                ...
                for i in range(0, len(generated_text), chunk_size):
                    ...
                    chunk = self._stream_chunk(
                        response_id, created, model_name, chunk_text, conv_id,
                    )
        ...
        return self._full_response(response_id, created, model_name, generated_text, prompt_tokens, completion_tokens, conv_id)
